...
Original file is located at
    https://colab.research.google.com/drive/1rfdTcJlgTgCXQdJAF4dguEYZreYOfsga
"""
...
def runge_kutta_step(func,dt,state):
    k1 = func(state)
...
class NeuralODE:
  ...
  def forward(self,inputs:tf.Tensor,return_states:Optional[str]=None):
      ...
      def forward_dynamics(_state):
        return [1.0,self._model(inputs=_state)]
      
      states=[]
      
      def append_state(_state):
        tensors=_state[1]
